...
class UserResource extends Resource
{
    ...
    protected static ?string $navigationGroup = 'User Managment'; // Optional: Grouping in the navigation
    ...
    public static function getNavigationBadgeTooltip(): ?string // Optional: Set the tooltip for the badge
    {
